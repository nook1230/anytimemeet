...
public interface MeetingReplyDao {
	///////// constants
	...
	int deleteReplyOfMeeting(int meetingId);
	...
	int getCountReplies(int meetingId);
	List<Reply> getReplies(int meetingId);
}
